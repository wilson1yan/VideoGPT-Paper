...
def pretty_info(*args) -> None:
    log(json.dumps(args, sort_keys=False, indent=4), level=INFO)


def debug_assert(*args) -> None:
    Logger.CURRENT.debug_assert(*args)
...
class Logger(object):
    ...
    def debug_assert(self, bool_exp, *msg) -> None:
        # if self.level <= DEBUG:  # TODO: bool_exp should be lambda: bool_exp, otherwise always evaluated
        assert bool_exp, msg
